...
@implementation WZ_Forward_ImageWeibo
- (NSURL *)weiboImageURL
{
    return [NSURL URLWithString:self.weiboImageURL_Str];
}
-(NSAttributedString *)attributedString_Retweeted_status
{
    NSString * str = self.retweeted_status;
